                ...
                <form id="bookingForm" class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="specialty_id" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-blue-500" required>
                        ...
                        <div>
                            ...
                            <select id="doctor_id" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-blue-500" required>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="date" id="start_date" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-blue-500" required>
                        ...
                        <div>
                            ...
                            <select id="start_time" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-blue-500" required>
                    ...
                    <div>
                        ...
                        <textarea id="reason" rows="4" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-blue-500" placeholder="Please describe your symptoms or reason for visit"></textarea>
                    </div>
...
function loadAvailableSlots() {
    ...
    fetch(`/api/doctors/${doctorId}/available-slots/${date}`)
        ...
        .catch(err => {
            ...
            document.getElementById('start_time').innerHTML = '<option value="">Error loading times</option>';
        });
}
